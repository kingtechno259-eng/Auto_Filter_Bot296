...
API_ID = int(environ.get('API_ID', '24799187')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '4baef40b8f24b66a25ccd232861186ed')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8320501572:AAGH_wkArm3odIJqEXAMcmCxZk7ixeRSCDc")    # Bot token from @BotFather
...
PICS_URL = (environ.get('PICS', 'https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg   ')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg https://graph.org/file/56b5deb73f3b132e2bb73.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '777000').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003911377505 -1003966498386').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003608642564'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003783577048'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003701375615'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5240160510')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003928657783')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+bnebtGcyeOs2YjU1')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003975682757")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003914711028")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/169d21f1a50bb4f34a387-524467302bc984cc73.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('manjappashirattti84-1@okaxis', 'ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɢʜᴛ ɴᴏᴡ')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Kingkishan:22996@cluster0.jpobaxp.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'TG_Files') # Collection name (default: dreamcinezone_files)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003722778120'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+bnebtGcyeOs2YjU1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/KingKN01') # Owner link for the bot
